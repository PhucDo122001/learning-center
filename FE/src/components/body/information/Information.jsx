            ...
            {user.numberCourses && user.numberCourses.length !== 0 ? (
              <div className="content-box">
                ...
                <li className="item">
                  ...
                  <li className="item">
                    <p className="active font-20px font-weight"> Đăng ký</p>
                  </li>
                  <li className="item">
                    <p className="active font-20px font-weight">Hoạt động </p>
                  </li>
                  <li className="item">
                    <p className="active font-20px font-weight">Thao tác độc lập</p>
                  </li>
                </ul>
